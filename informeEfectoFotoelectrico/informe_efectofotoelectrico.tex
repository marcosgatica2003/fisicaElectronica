...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node [line width=2pt] at (17cm, -3.5cm) {\includegraphics[width=3cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/utn.png}};
		\node [line width=2pt] at (7.5cm, -7.5cm) {\includegraphics[width=6cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/LGH_PhotoelectricEffect.es_ES.x512.png}};
...
\setlength{\footskip}{20pt} % explain this line: 
  ...
  \flushbottom
    \section{INTRODUCCIÓN}
      \subsection{Electroscopio de Wulf}
        ...
        \begin{figure}[h]
          \centering
          \includegraphics[width=4.5cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/electroscopio.jpg}
    ...
    \section{PRIMERA EXPERIENCIA}
      \subsection{Energía como función de la intensidad de la luz}
        ...
        \vspace{0mm}
          ...
          \begin{figure}[h]
            \centering
            \includegraphics[trim={0 30cm 0 30cm},clip,width=4.5cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/filtro1.jpg}
            \caption{Filtro 1}
          \end{figure}

          \begin{figure}[h]       
            \centering
              \includegraphics[trim={0 30cm 0 30cm},clip,width=4.5cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/filtro2.jpg}
              \caption{Filtro 2}
        \end{figure}
          
        \begin{figure}[h]
                \centering
                \includegraphics[width=4.5cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/filtro3.jpg}
                \caption{Filtro 3}
        \end{figure}
        \vspace{5mm}
        ...
        \begin{figure}[h]
          \centering
          \includegraphics[width=6.7cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/amarillo_energia_intensidad.png}
          \caption{\small Energía como función de la intensidad de la luz}
        \end{figure}

        \begin{figure}[h]
          \centering
          \includegraphics[width=6.7cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/verde_energia_intensidad.png}
          \caption{\small Energía como función de la intensidad de la luz}
        \end{figure}
    ...
    \section{SEGUNDA EXPERIENCIA}
      ...
      \begin{figure}[h]
        \centering
        \includegraphics[width=6cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/dispositivo_2daexperiencia.jpg}
        \caption{Fotodiodo}
      \end{figure}
      ...
      \begin{figure}[h]
        \centering
        \includegraphics[width=6.7cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/1er_orden.png}
        \caption{\small 1er orden del espectro}
      \end{figure} 

      \begin{figure}[ht]
        \centering
        \includegraphics[width=6.5cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/2do_orden.png}
      ...
      \begin{figure}[h]
        \centering
        \includegraphics[width=6.5cm]{/home/valentino/Documents/Facultad/Fisica_Electrónica/fisicaElectronica/imagenes/promedio1ery2do_orden.png}
