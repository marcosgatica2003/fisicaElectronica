...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node [line width=2pt] at (17cm, -3.5cm) {\includegraphics[width=3cm]{../imagenes/utn.png}};
		\node [line width=2pt] at (7.5cm, -7.5cm) {\includegraphics[width=6cm]{../imagenes/LGH_PhotoelectricEffect.es_ES.x512.png}};
...
\fancyfoot[R]{[Rao V. - Perea I. - Pannunzio S. - Parfait M. - Filsinger G. - Coronel A. - Gatica M.] [\textbf{pág. \thepage]}}
